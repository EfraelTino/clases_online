...
if (!$cursoTerminado) {
    ...
    <body class="bg-principal">
        <div class="container d-flex justify-content-center align-items-center h-100">
            <div class="card bg-dark p-2 p-md-5 m-md-5">
                <div class="row d-flex justify-content-center m-2 m-sm-4 m-md-5">
                    <div class="col-12 d-flex justify-content-center">
                        <img src="./assets/img/congrat.webp" alt="Imagen felicitaciones" loading="lazy" style="max-width: 220px;">
                    </div>
                    <div class="col-12 mt-4">
                        <h2 class="fw-normal text-center text-white">¡Felicitaciones!</h3>
                    </div>
                    <div class="col-12">
                        <h4 class="text-center text-decoration-underline fw-bold">
                            <?php
                    ...
                    <div class="col-12">
                        <p class="text-center ">Nuestros cursos <strong>se actualizan regularmente para mantenerte al día</strong>. Con tu membresía mensual, tendrás acceso completo a todos los cursos actualizados. Sabemos que el camino hacia el éxito puede ser desafiante, pero estamos aquí para apoyarte en cada paso del camino.</p>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12 d-flex justify-content-center">
                            <a class="btn btn-primary fw-bold px-5 px-2" href="./courses.php">Continuar aprendiendo <svg
